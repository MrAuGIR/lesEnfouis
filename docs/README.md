...
> · 🖼️ **Concept art (itérations designer) : [`concept-art/`](../concept-art/)** — [couche Industrielle](../concept-art/planche-style-couche-industrielle.png) · [héros](../concept-art/concept-hero.png) (+ retours)
